...
const char *modefullnames[] =
{
    ...
    "keep the flag", "team pistol frenzy", "team last swiss standing", "bot pistol frenzy", "bot last swiss standing", "bot team survivor", "bot team one shot, one kill", "GEMA"
};
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    SV_DISCSCORES, 0, SV_TIMEUP, 5, SV_EDITENT, 13, SV_ITEMACC, 2,
